...
CREATE TABLE REP_RENDIMIENTO_VS_DESVIACION(
	...
	DesvCantJuego1 NUMERIC(18,3),
    DesvCantJuegoX NUMERIC(18,3),
    DesvCantJuego2 NUMERIC(18,3),
	DesvPorcentual1 NUMERIC(18,3),
    DesvPorcentualX NUMERIC(18,3),
    DesvPorcentual2 NUMERIC(18,3),

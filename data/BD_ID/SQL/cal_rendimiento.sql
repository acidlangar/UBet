...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[cal_rendimiento]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[cal_rendimiento]
GO
...
-- =============================================
CREATE PROCEDURE cal_rendimiento 
AS
BEGIN
	SET NOCOUNT ON;
